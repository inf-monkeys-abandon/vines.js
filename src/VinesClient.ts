 ...
 * @returns any
 */
public async createNewVersionWorkflow(workflowId: string,
 ...
 * @returns any
 */
public async validateWorkflow(requestBody: ValidateWorkflowDto,
): Promise<any> {
    return await this.httpClient.request({
        method: 'POST',
 ...
 * @returns any
 */
public async debugWorkflow(workflowId: string,
 ...
 * @returns any
 */
public async generateTeamDiveInToken({
    teamId,
}: {
    teamId: string,
}): Promise<any> {
 ...
 * @returns any
 */
public async pinPage(pageId: string,
): Promise<any> {
    return await this.httpClient.request({
        method: 'POST',
 ...
 * @returns any
 */
public async getResourceByHash({
    md5,
}: {
    md5: string,
}): Promise<any> {
 ...
 * @returns any
 */
public async listResources(requestBody: ListDto,
): Promise<any> {
    return await this.httpClient.request({
        method: 'POST',
 ...
 * @returns any
 */
public async createApiKey(requestBody: CreateApiKeyDto,
): Promise<any> {
    return await this.httpClient.request({
        method: 'POST',
        url: '/api/apikeys',
 ...
 * @returns any
 */
public async updateUserInfo(requestBody: UpdateUserInfoDto,
): Promise<any> {
    return await this.httpClient.request({
        method: 'POST',
 ...
 * @returns any
 */
public async createFilterRule(requestBody: UpdateUgcFilterRuleDto,
): Promise<any> {
    return await this.httpClient.request({
        method: 'POST',
        url: '/api/ugc/filters',
 ...
 * @returns any
 */
public async updateFilterRule(id: string,
 ...
 * @returns any
 */
public async removeFilterRule(id: string,
): Promise<any> {
    return await this.httpClient.request({
        method: 'DELETE',
        url: '/api/ugc/filters/{id}',
 ...
 * @returns any
 */
public async updateUgcItem(requestBody: UpdateUgcItemDto,
): Promise<any> {
    return await this.httpClient.request({
        method: 'POST',
        url: '/api/ugc/update',
 ...
 * @returns any
 */
public async addAdministrator(requestBody: NamePasswordDto,
): Promise<any> {
    return await this.httpClient.request({
        method: 'POST',
        url: '/api/administrator',
 ...
 * @returns any
 */
public async removeAdministrator(id: string,
): Promise<any> {
    return await this.httpClient.request({
        method: 'DELETE',
 ...
 * @returns any
 */
public async updatePassword(id: string,
): Promise<any> {
    return await this.httpClient.request({
        method: 'PUT',
        url: '/api/administrator/{id}',
